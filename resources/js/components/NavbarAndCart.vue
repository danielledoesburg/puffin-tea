...
<div class="position-right-flex">
   ...
   id="change-the-position">
        ...
        <div v-for="product in cart_no_repetition" class="row" id="row-width">
            <div class="column">
                <img class="tinypic" :src="imagePath + products[product -1].main_image.filename">
            </div>
            <div class="column" id="display-basket-description">
                <div id="cartitems-margin-right">
                    ...
                    <div class="quantity">
                        ...
                        <input name="quantity" type="text" class="quantity__input" :value="products_for_cart[product].quantity">
                        <a href="#"  v-on:click="plusToCart(cart_no_repetition.indexOf(product))" class="quantity__plus">
                            <span>+</span>
                        </a>
                    </div>
                </div>
